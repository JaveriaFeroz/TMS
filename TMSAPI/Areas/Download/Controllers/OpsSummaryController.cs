...
namespace TMSAPI.Areas.Download.Controllers
{
    ...
    public class OpsSummaryController : ControllerBase
    {
        ...
        public IActionResult Get(DateTime dateFrom, DateTime dateTo)
        {
            try
            {
                return Ok(OperationalSummary.Get(dateFrom, dateTo, Session.GetCompanyId(HttpContext), Session.GetUserId(HttpContext)));
            }
