...
import { PLSummaryService } from './plsummary.service';
...
export class PLSummaryComponent implements OnInit {
  public goRoutePL: GridOptions;
  public goConsigneePL: GridOptions;
  readonly optionName: string = 'Profit and Loss';
  //model: any = {};
  //frm: any;
  errors: string[] = [];
  frmPLReport: any;
  ...
  constructor(private router: Router, private formbulider: FormBuilder,
    private svcPLDownload: PLSummaryService, private svcToaster: agToasterService, private svcWaitDlg: WaitDialogService) {
    this.enablePartialDelivery = agFormHelper.enablePartialDelivery(); //data.enablePartialDelivery;

    this.period = agFormHelper.opsPeriodId();
    this.initGrid();
    this.loadLookup();
  ...
  ngOnInit(): void {
    this.frmPLReport = this.formbulider.group({
      dataBasisId: ["0", [Validators.required]],
      dateFrom: [null],
      dateTo: [null],
      jobPeriod: [null],
    ...
    try {
      ...
      if (formData.dataBasisId == null) {
        ...
        if (!this.enablePartialDelivery) {        
          this.svcPLDownload.GetRoutePL(formData.dateFrom, formData.dateTo, formData.jobPeriod, formData.dataBasisId).subscribe(
            profitloss => {
        ...
        if (this.enablePartialDelivery) {
          this.svcPLDownload.GetConsigneePL(formData.dateFrom, formData.dateTo, formData.jobPeriod, formData.dataBasisId).subscribe(
            profitloss => {
              if (Object.keys(profitloss).length > 0  ) {
 ...
 //#endregion toolbar functions
  ...
  colRoutePL = [
    ...
    {
      headerName: "TripRevenue", field: "tripRevenue", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 120
    },
    {
      headerName: "FuelCostPerKM ", field: "fuelCostPerKM", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 120
    },
    {
      headerName: "Distance", field: "distance", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 100
    },
    {
      headerName: "FuelCost", field: "fuelCost", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 100
    },
    {
      headerName: "Weight", field: "weight", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 100
    },
    {
      headerName: "TotalCost", field: "totalCost", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 100
    },
    {
      headerName: "NetRevenue", field: "netRevenue", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 120
    },
    {
      headerName: "KMPerLitre", field: "kmperLitre", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
    ...
    {
      headerName: "DetHrs", field: "detentionHours", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 100
    },
    {
    ...
    {
      headerName: "Fuel", field: "fuel", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 100
    },
    {
      headerName: "OutSourcedVehicle", field: "outSourcedVehicle", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 150
    },
    {
      headerName: "Penalty", field: "penalty", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 100
    },
    {
    ...
    {
      headerName: "Offloading", field: "offloading", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 100
    },
    {
      headerName: "OnRouteMaint", field: "onRouteMaintainance", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 150
    },
    {
      headerName: "HSSEIncentive", field: "hsseIncentive", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 150
    },
    {
      headerName: "OutsourceDetention", field: "outsourceDetention", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 150
    },
    //{
  ...
  colConsigneePL = [
    ...
    {
      headerName: "ConsigneeRate", field: "consigneeRate", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 120
    },
    {
      headerName: "TripRevenue", field: "tripRevenue", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 110
    },
    {
      headerName: "NetRevenue", field: "netRevenue", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 110
    ...
    {
      headerName: "FuelLtr", field: "fuelLtrs", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 100
    },
    {
      headerName: "FuelCostPerKM", field: "fuelCostPerKM", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
    ...
    {
      headerName: "CashFuel", field: "fuel", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 100
    },
    {
    ...
    {
      headerName: "OutSourcedVehicle", field: "outSourcedVehicle", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 140
    },
    {
      headerName: "RepairAndMaintenance", field: "onRouteMaintainance", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 140
    },
    {
      headerName: "Loading", field: "loading", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
    ...
    {
      headerName: "TajTollTax", field: "tajTollTax", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 100
    },
    {
      headerName: "TajFood", field: "tajFood", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 100
    },
    {
      headerName: "TajUnReceipted", field: "tajUnReceiptedExpense", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 140
    },
    {
      headerName: "TajDriverIncentive", field: "tajDriverIncentive", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 140
    },
    {
      headerName: "TajRepairAndMaintenance", field: "tajRepairMaintenance", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 140
    },
    {
      headerName: "TajLoadingUnloadingCharges", field: "tajLoadingUnLoading", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 140
    },
    {
      headerName: "TajDriverSpecialIncentive", field: "tajDriverSpecialIncentive", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 140
    },
    {
      headerName: "Taj Misc", field: "tajMisc", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 140
    },
    
    {
      headerName: "FuelCreditCash", field: "fuelCreditCash", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 140
    },
    {
    ...
    {
      headerName: "TripExpense", field: "expenseAmount", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 110
    },
    {
      headerName: "KMPerLtr", field: "kmperLitre", type: "numericColumn", valueFormatter: agGridHelper.formatNumbers,
      valueParser: agGridHelper.numberValueParser, editable: false, width: 100
    },
    {
      headerName: "Delivery", field: "deliveryDateTime", editable: false, width: 150
  ...
  initGrid() {
    ...
    if (this.enablePartialDelivery ) {
      this.goConsigneePL = <GridOptions>{
        headerHeight: 25,
        rowHeight: 32,
        animateRows: true,
        defaultColDef: {
 ...
 //#region local functions
  ...
  private loadLookup() {
    try {
      this.svcPLDownload.getLookup().subscribe(
        data => {          
