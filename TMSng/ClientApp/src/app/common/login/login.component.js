...
let LoginComponent = class LoginComponent {
    constructor(router, svcLogin, auth, svcToaster, svcWaitDlg) {
        ...
        this.model = { UserId: null, UserName: null, Password: null, CompanyId: null };
        this.UserAccess = {};
    }
    ngAfterViewInit() { }
    ngOnInit() {
                ...
                if (data.message === "Successful") {
                    ...
                    this.getUserMenuAndAccess()
                        ...
                        this.router.navigate(['/MainForm'])
                            .then(success => console.log('Navigation to MainForm successful'), navigationError => {
    ...
    async getUserMenuAndAccess() {
        return new Promise((resolve, reject) => {
            try {
                ...
                (0, rxjs_1.forkJoin)([_userAccess, _userMenu, _company, _userRole, _companyconfig])
                    .subscribe({
                    next: (results) => {
