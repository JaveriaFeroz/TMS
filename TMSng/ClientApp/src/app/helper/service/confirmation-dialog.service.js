...
const confirmation_dialog_component_1 = require("../_confirmDialog/confirmation-dialog.component");
let ConfirmationDialogService = class ConfirmationDialogService {
    ...
    confirm(title, message, btnOkText = 'OK', btnCancelText = 'Cancel', dialogSize = 'sm') {
        const modalRef = this.modalService.open(confirmation_dialog_component_1.ConfirmationDialogComponent, { size: dialogSize });
